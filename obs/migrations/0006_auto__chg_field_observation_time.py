...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Observation.time'
        db.alter_column(u'obs_observation', 'time', self.gf('django.db.models.fields.CharField')(max_length=8, null=True))

    def backwards(self, orm):

        # Changing field 'Observation.time'
        db.alter_column(u'obs_observation', 'time', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        u'obs.observation': {
            ...
            'time': ('django.db.models.fields.CharField', [], {'max_length': '8', 'null': 'True', 'blank': 'True'}),
